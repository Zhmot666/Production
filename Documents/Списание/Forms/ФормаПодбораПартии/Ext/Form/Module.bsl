...
//
//	Склад  - Справочники.Склад - Склад приходования продукции
//
// Возвращаемое значение:
//   Число   - Величина выпущенной партии
//
&НаСервере
Функция ВелеичнаПартии(Номенклатура, ДатаВыпуска, НомерПартии, Склад)
...
КонецФункции // ВелеичнаПартии(Номенклатура, ДатаВыпуска, НомерПартии, Склад)
...
Функция ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		СтрокаТО.ОбъемПартии = ВелеичнаПартии(ВыборкаДетальныеЗаписи.Номенклатура, ВыборкаДетальныеЗаписи.ДатаВыпуска, ВыборкаДетальныеЗаписи.НомерПартии, Параметры.ОстСклад);
	КонецЦикла;
		СтрокаТО = ВыборПартии.Добавить();
