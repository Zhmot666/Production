...
//
// Возвращаемое значение:
//   Булево   - Истина если всё хорошо, Ложь, если есть совпадения
//
&НаСервере
...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	Функция ПолучитьКонтрольныеЗнакиНаСервере()
		Возврат Справочники.Номенклатура.НайтиПоНаименованию("Контрольные знаки");
	КонецФункции
